...
export interface CostEstimate {
  ...
  nearbyAffordableOptions: string[];
}
...
export async function translateReport(
  report: Report,
  language: string
): Promise<{ simplified: string; terms: string; steps: string }> {
...
// ── New Health Finance AI Features ─────────────────────────────────────────
...
export async function analyzeSymptoms(
  ...
  return callEdge("symptoms", { symptoms, age, location });
}
...
export async function findClinics(
  ...
  return callEdge("clinics", { location, condition, budget });
}
...
export async function estimateCost(
  ...
  return callEdge("cost", { procedure, location, hasInsurance });
}
...
export async function getInsurancePlans(
  ...
  return callEdge("insurance", { income, familySize, location, conditions });
}
...
export async function getPaymentPlans(
  ...
  return callEdge("payment-plans", { billAmount, creditScore });
}
