  ...
  if (!report) {
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center text-center p-8">
        ...
        <Link href="/"><Button>Go to RADapp</Button></Link>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-background">
      <div className="bg-primary/10 border-b border-primary/20 py-3 px-4 text-center">
        <div className="flex items-center justify-center gap-2 text-sm text-primary">
          ...
          <span>This report was shared via <strong>RADapp</strong> — AI Radiology Assistant</span>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="mt-8 pt-6 border-t border-border text-center">
          ...
          <Link href="/signup"><Button className="gap-2">Get started free with RADapp</Button></Link>
        </div>
      </div>
    </div>
  );
