...
export default function Dashboard() {
  ...
  const { data: recent, isLoading: recentLoading } = useGetRecentReports();
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        >
          ...
          <StatCard
            label="Low Urgency"
            value={stats?.urgencyBreakdown?.low ?? 0}
            icon={CheckCircle}
          ...
          <StatCard
            ...
            value={stats?.urgencyBreakdown?.moderate ?? 0}
            icon={AlertTriangle}
            ...
            <div className="space-y-4">
              <div className="p-5 rounded-2xl border border-border bg-card">
                ...
                {statsLoading ? (
                  ...
                  <div className="text-2xl font-bold text-primary">{stats?.recentActivity ?? 0}</div>
                )}
              ...
              <div className="p-5 rounded-2xl border border-primary/20 bg-primary/5">
                ...
                <Link href="/chat">
                  <Button size="sm" className="w-full gap-2" data-testid="button-open-chat">
                    Open AI Chat
