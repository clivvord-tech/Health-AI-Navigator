      ...
      <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="flex-1 rounded-2xl border border-border bg-card overflow-hidden flex flex-col min-h-0">
          <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-4" style={{ minHeight: "400px", maxHeight: "60vh" }}>
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full py-12 text-center">
                ...
                <p className="text-sm text-muted-foreground max-w-xs">Ask any question about radiology reports, medical imaging, or your findings.</p>
              </div>
            )}
            {isSending && (
          ...
          <div className="p-4 border-t border-border">
            ...
            <p className="text-xs text-muted-foreground mt-2 text-center">AI responses are for educational purposes only — not medical advice</p>
          </div>
        </div>
      </div>
    </div>
